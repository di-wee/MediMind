            ...
            <div className="p-5 flex flex-col h-full">
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-baseline space-x-3">
                    <p className="text-sm text-gray-500 font-medium">NRIC: ****{patient.nric.slice(-4)}</p>
                    {/* Gender Badge */}
              ...
              <div className="mb-6 flex-grow">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      <p className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Clinic</p>
                      <p className="text-sm font-semibold text-gray-900">{patient.clinicName}</p>
                    </div>
                    <div>
                      <p className="text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Assigned Doctor</p>
                      <p className="text-sm font-semibold text-gray-900">{patient.assignedDoctor}</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-500 mb-4">
              {searchTerm ? 'Try adjusting your search terms.' : 'No assigned patients yet.'}
            </p>
            {!searchTerm && (
              <button 
